...
//Implementation class for OrderDao interface.
public class OrderDaoimpl implements OrderDao {
	...
	public Order getOrder(String orderID) {
		try (Session session = HibernateUtil.getSession()) {
			...
			Order order = session.get(Order.class, orderID);// Retrieve order by ID
			return order;
	...
	public List<Order> getAllOrder() {
		try (Session session = HibernateUtil.getSession()) {
			...
			// execute HQL query to retrieve all order data
